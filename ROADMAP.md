...
## Beszerzési döntéstámogatás, árrés, készletérték-mutatók — FEJLESZTÉS ALATT (1.3.0)

**Nincs lezárva, nincs kiadva — a verziószám még 1.2.0, ez a szakasz a folyamatban lévő fejlesztést dokumentálja.** Az 1.2.0 Dashboard/riportok/forecast alapjára építve: a rendszer mostantól KONKRÉT beszerzési döntést is támogat (biztonsági készlet, rendelési pont, javasolt mennyiség, sürgősség, indoklás — lásd README "FountainTrade 1.3.0" szakasza), plusz termékszintű és riport-szintű árrés-számítás és készletérték-mutatók (nettó beszerzési ÉS eladási áron). Minden számítás a MEGLÉVŐ adatmodellből (purchase_items, products.net_price/.purchase_price_net) és a MEGLÉVŐ forecast-logikából (getStockForecastBulk) épül — nincs új adatbázistábla, nincs új migráció.

**Tudatosan NEM implementált ebben a körben** (dokumentált korlát, nem hiányosság): a "Megrendelve → Részben beérkezett → Beérkezett" teljes beszerzési workflow-állapotgép. A jelenlegi `purchases`/`purchase_items` adatmodell egyetlen, atomikus "a készlet MOST megérkezett" eseményt ír le — nincs benne "megrendelve, de még nem érkezett meg" vagy "részlegesen érkezett" fogalom. Ennek bevezetése a beszerzési tételek szintjén rendelt-vs-beérkezett mennyiség külön követését igényelné — ez egy valódi, önálló architekturális bővítés lenne, nem "a hiányzó állapotkezelés kiegészítése". Helyette a lista két, a MEGLÉVŐ adatokból levezetett állapotot különböztet meg: "Javasolt" (még nem volt rá közelmúltbeli beszerzés) és "Folyamatban" (volt már rá beszerzés az elmúlt 3 napban, de a készlet még mindig alacsony).
