...
async function loadAuditLog() {
    ...
    try {
        const data = await fetchJson('/api/audit-log.php');
        ...
        body.innerHTML = `<tr><td colspan="5" class="feedback error">A napló betöltése sikertelen: ${escapeHtml(err.message)}</td></tr>`;
    }
}
