...
<title>Stock Manager — Beszerzések</title>
...
<header class="topbar">
    <div class="topbar-brand">
        <span class="topbar-icon-square" id="topbar-icon-square"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg></span>
        <h1>Beszerzések</h1>
    </div>
...
<div class="import-panel">
    ...
    <div class="import-card">
        <div class="filter-grid">
            ...
            <div>
                <label for="f-query">Beszállító neve</label>
...
<script src="beszerzesek.js"></script>
</body>
</html>
