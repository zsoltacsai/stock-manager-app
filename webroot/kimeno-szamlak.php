...
<title>Stock Manager — Kimenő számlák</title>
    ...
    <div class="import-card">
        <div class="filter-grid">
            ...
            <div>
                ...
                <input type="text" id="f-id" placeholder="# (számla vagy eladás)">
            </div>
            <div>
                <label for="f-provider">Szolgáltató</label>
            ...
            <div>
                ...
                <select id="f-status">
                    <option value="">Mind</option>
                    <option value="done">Kiállítva</option>
                    <option value="pending">Folyamatban</option>
                    <option value="failed">Sikertelen</option>
                </select>
            </div>
            <div>
                <label for="f-query">Vevő / számlaszám</label>
                <input type="text" id="f-query" placeholder="Keresés...">
            </div>
            <div>
                <label class="gt-hidden-label">Műveletek</label>
                <div style="display:flex; gap:8px;">
                    <button id="clear-filters-btn" class="btn btn-secondary toolbar-btn" style="flex:1;">Szűrők törlése</button>
